...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          description: "",
          section: "News",},{id: "news-completed-a-year-long-certificate-in-urban-humanities-through-citylab-ucla-city-sunset",
          title: 'Completed a year-long certificate in Urban Humanities through CityLab-UCLA :city_sunset:',
          description: "",
          section: "News",},{
        id: 'social-email',
        title: 'email',
